...
FyF=np.loadtxt('/home/summit/Spidoo_ws/src/stiffness_observer/scripts/Gazebo_data/PLOT/Fy_rear_left_V8.txt')
FyR=np.loadtxt('/home/summit/Spidoo_ws/src/stiffness_observer/scripts/Gazebo_data/PLOT/Fy_front_right_V8.txt')
res=np.loadtxt('/home/summit/Spidoo_ws/src/stiffness_observer/scripts/Gazebo_data/PLOT/Traj_V8.txt')
sim=np.loadtxt('/home/summit/Spidoo_ws/src/stiffness_observer/scripts/Gazebo_data/PLOT/LQR_Stif_V8.txt')
...
plt.grid(True)
plt.legend(["$F_{yf}$ estimated with NL observer","$F_{yf}$ with averge estimation of $C_f$ and $C_r$","$F_{yf}$ calculated by Gazebo simulator"],fontsize=25)
...
plt.grid(True)
plt.legend(["$F_{yr}$ estimated with NL observer","$F_{yr}$ with averge estimation of $C_f$ and $C_r$","$F_{yr}$ calculated by Gazebo simulator"],fontsize=25)
...
plt.grid(True)
plt.legend(["$F_{yf}$ with NL observer  ","$F_{yf}$ calculated by Gazebo "],fontsize=48)
...
plt.grid(True)
plt.legend(["$F_{yr}$ with NL observer  ","$F_{yr}$ calculated by Gazebo "],fontsize=48)

...
annotate(r'Without  NLO ' '\n' 'at $V_x=8m.s^{-1}$',
         ...
         xytext=(+60, +33), textcoords='offset points', fontsize=18,
...
annotate(r'Without NLO' '\n' 'at $V_x=5m.s^{-1}$',
         ...
         xytext=(-90,-90), textcoords='offset points', fontsize=18,
...
annotate(r'With NLO ' '\n' 'at $V_x=5m.s^{-1}$',
         ...
         xytext=(-45, 45), textcoords='offset points', fontsize=18,
...
annotate(r'Without NLO ' '\n' 'at $V_x=8m.s^{-1}$',
         xy=(t,y2[2555]*kk), xycoords='data',color='g',
...
annotate(r'Without  NLO' '\n' 'at $V_x=5m.s^{-1}$',
         ...
         xytext=(50, -50), textcoords='offset points', fontsize=18,
         arrowprops=dict(arrowstyle="->", connectionstyle="arc3,rad=.2",color='k'))
...
annotate(r'With NLO' '\n' 'at $V_x=8m.s^{-1}$',
         ...
         xytext=(-60, 60), textcoords='offset points', fontsize=18,
         arrowprops=dict(arrowstyle="->", connectionstyle="arc3,rad=.2",color='b'))
...
annotate(r'With NLO ' '\n' 'at $V_x=5m.s^{-1}$',
         ...
         xytext=(-80, 80), textcoords='offset points', fontsize=18,
         arrowprops=dict(arrowstyle="->", connectionstyle="arc3,rad=.2",color='r'))

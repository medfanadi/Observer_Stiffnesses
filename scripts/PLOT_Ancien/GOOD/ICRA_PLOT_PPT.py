...
Obs=np.loadtxt('/home/summit/Spidoo_ws/src/stiffness_observer/scripts/PLOT_Ancien/GOOD/Obse_Stif_V8.txt')
WithOb=np.loadtxt('/home/summit/Spidoo_ws/src/stiffness_observer/scripts/PLOT_Ancien/GOOD/Without_Stif_V8.txt')

Obs2=np.loadtxt('/home/summit/Spidoo_ws/src/stiffness_observer/scripts/PLOT_Ancien/GOOD/Obse_Stif_V5.txt')   #  Obse_Stif_V5_C
WithOb2=np.loadtxt('/home/summit/Spidoo_ws/src/stiffness_observer/scripts/PLOT_Ancien/GOOD/Without_Stif_V5.txt')
...
annotate(r'Without  NLO & RAO ' '\n' 'at $V_x=8m.s^{-1}$',
         xy=(t,y2[1900]), xycoords='data',color='g',
         xytext=(+60, +33), textcoords='offset points', fontsize=15,
...
annotate(r'Without NLO & RAO ' '\n' 'at $V_x=5m.s^{-1}$',
         xy=(t,y22[1450]), xycoords='data',color='k',
         xytext=(-90,-90), textcoords='offset points', fontsize=15,
         arrowprops=dict(arrowstyle="->", connectionstyle="arc3,rad=.2",color='k'))

t=s4[2050]


annotate(r'With NLO & RAO ' '\n' 'at $V_x=8m.s^{-1}$',
         xy=(t,y4[2050]), xycoords='data',color='b',
         xytext=(-90, 90), textcoords='offset points', fontsize=15,
...
annotate(r'With NLO & RAO ' '\n' 'at $V_x=5m.s^{-1}$',
         xy=(t,y44[1100]), xycoords='data',color='r',
         xytext=(-40, 45), textcoords='offset points', fontsize=15,
...
#savefig('demo.png', transparent=True,dpi=1000)
plt.savefig("GOOD1.png", transparent=True)
plt.show()
...
plt.plot(s44[:],y44[:]*kk, 'r', linewidth=3)
plt.plot(s22[:],y22[:]*kk, 'k--', linewidth=3)

plt.plot(s4[:],y4[:]*kk, 'b', linewidth=3)
plt.plot(s2[:],y2[:]*kk, 'g--', linewidth=3)

#plt.text(10,4.3,'$(b)$', fontsize=45)

plt.xlabel('Curvilinear abscissa  [m]', fontsize=18)
plt.ylabel('Angualr error $[degree]$', fontsize=18)
plt.grid(True)
#plt.legend(["$e_y$ with NL observer at $V_x=5m.s^{-1}$ ","$e_y$ Without  observer $C_f$ and $C_r$ at $V_x=5m.s^{-1}$ ","$e_y$ with NL observer at $V_x=8m.s^{-1}$ ","$e_y$ Without  observer $C_f$ and $C_r$ at $V_x=8m.s^{-1}$ "],loc='upper left',fontsize=35)
...
annotate(r'Without NLO' '\n' '& RAO '  '\n' 'at $V_x=8m.s^{-1}$',
         xy=(t,y2[2600]*kk), xycoords='data',color='g',
         xytext=(+33, +33), textcoords='offset points', fontsize=15,
         arrowprops=dict(arrowstyle="->", connectionstyle="arc3,rad=.2",color='g'))
...
annotate(r'Without NLO & RAO ' '\n' 'at $V_x=5m.s^{-1}$',
         xy=(t,y22[1600]*kk), xycoords='data',color='k',
         xytext=(50, -50), textcoords='offset points', fontsize=15,
         arrowprops=dict(arrowstyle="->", connectionstyle="arc3,rad=.2",color='k'))
...
annotate(r'With NLO' '\n' '& RAO '  '\n' 'at $V_x=8m.s^{-1}$',
         xy=(t,y4[3200]*kk), xycoords='data',color='b',
         xytext=(-60, 60), textcoords='offset points', fontsize=15,
         arrowprops=dict(arrowstyle="->", connectionstyle="arc3,rad=.2",color='b'))
...
annotate(r'With NLO & RAO  ' '\n' 'at $V_x=5m.s^{-1}$',
         xy=(t,y44[1300]*kk), xycoords='data',color='r',
         xytext=(-80, 80), textcoords='offset points', fontsize=15,
         arrowprops=dict(arrowstyle="->", connectionstyle="arc3,rad=.2",color='r'))


plt.xlim((4, 112))   # set the xlim to xmin, xmax
#plt.ylim(xmin, xmax)     # set the xlim to xmin, xmax
plt.savefig("GOOD2.png", transparent=True)
plt.show()
...
plt.xlabel('Curvilinear abscissa  [m]', fontsize=45)
plt.ylabel('Angualr error $[^\\circ]$', fontsize=45)
plt.grid(True)
#plt.legend(["$e_y$ with NL observer at $V_x=5m.s^{-1}$ ","$e_y$ Without  observer $C_f$ and $C_r$ at $V_x=5m.s^{-1}$ ","$e_y$ with NL observer at $V_x=8m.s^{-1}$ ","$e_y$ Without  observer $C_f$ and $C_r$ at $V_x=8m.s^{-1}$ "],loc='upper left',fontsize=35)
...
plt.plot(s44[:],Obs2[:,17], 'r', linewidth=2)
plt.plot(s44[:],Obs2[:,16], 'b', linewidth=2)


plt.plot(s4[:],Obs[:,17]-2600*np.ones(len(yf4)), 'magenta', linewidth=2)
plt.plot(s4[:],Obs[:,16]-2600*np.ones(len(yf4)), 'g', linewidth=2)

#plt.text(4,48000,'$(c)$', fontsize=60)


plt.xlabel('Curvilinear abscissa  [m]', fontsize=15)
plt.ylabel('Cornering stiffness $[N.rad^{-1}]$', fontsize=11)
plt.grid(True)
plt.legend(["$\\hat{C}_r$ at $V_x=5m.s^{-1}$","$\\hat{C}_f$ at $V_x=5m.s^{-1}$","$\\hat{C}_r$ at $V_x=8m.s^{-1}$","$\\hat{C}_f$ at $V_x=8m.s^{-1}$"],fontsize=15)


plt.xlim((5, 117))   # set the xlim to xmin, xmax
plt.ylim((0, 55000))   # set the xlim to xmin, xmax

plt.yticks( color='k', size=15)
plt.xticks( color='k', size=15)
plt.savefig("GOOD3.png", transparent=True)
plt.show()
